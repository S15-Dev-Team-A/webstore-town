...
$(document).ready(function (){
    ...
    $('#edit_bio').on('submit', function (e){
        ...
        $.post('/checkPassword', {pw: pw}, function (result){
            ...
            if (result){
                $.post('/updateProfile', {username: username, picdata: picdata, pictype: pictype, newpw: newpw}, function(result){
                    if (result){
                        console.log(result);
                        $('#error').text('Profile Updated Successfully!');
                        $('#error').css('color', 'green');
                    }else{
                        $('#error').text('Invalid New Password Format!');
                        $('#error').css('color', 'red');
                    }
                });
                ...
                $('#error').text('Current/Old Password is Incorrect!');
                $('#error').css('color', 'red');
            }
        });
