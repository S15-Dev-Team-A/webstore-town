...
const interiorController = {
    ...
    hoverProduct: async function (req, res) {
        ...
        padding:15px;">
            <div class="hori">
                <div class="vert">
                    <img src="data:${result.imgType};base64, ${result.imgBuffer}" width="200px" height="200px">
                </div>
            </div>
            <hr class="separator">
                <div class="vert" style="justify-content: space-between;">
                        ...
                        <p style="color:black; margin-top: 10px; margin-bottom:-10px;">by ${result.merchantBrand} </p>
                        <p style="color:black; margin-top: 20px; margin-bottom:20px; font-size:20px; font-weight:450;">${result.cost} PHP </p>
                        <p style="color:black; margin-top: -20px; margin-bottom:20px; font-size:20px; font-weight:450;">Has ${result.variations.length} variations</p>
